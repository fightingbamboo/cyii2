...
class Logger extends Component
{
    ...
    public function init()
    {
        ...
        register_shutdown_function( function () {
            ...
            register_shutdown_function([logger, "flush"], true);
        });
        */
    ...
    {
        var levels = [];
        let levels[$static::LEVEL_ERROR] = "error",
            levels[$static::LEVEL_WARNING] = "warning",
            levels[$static::LEVEL_INFO] = "info",
            levels[$static::LEVEL_TRACE] = "trace",
            levels[$static::LEVEL_PROFILE_BEGIN] = "profile begin",
            levels[$static::LEVEL_PROFILE_END] = "profile end";
