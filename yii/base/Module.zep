...
class Module extends ServiceLocator
{
    ...
    public static function getInstance()
    {
        ...
        if isset BaseYii::app->loadedModules[classs] {
            return BaseYii::app->loadedModules[classs];
        } else {
            return null;
        }
    }
    ...
    public static function setInstance( instance )
    {
        ...
        if instance === null {
            let classs = get_called_class();
            unset app->loadedModules[ classs ];
        } else {
            let classs = get_class(instance);
            let app->loadedModules[ classs ] = instance;
        }
    }
    ...
    public function getVersion()
    {
        if (this->_version === null) {
            let this->_version = this->defaultVersion();
        } else {
            if (!is_scalar(this->_version)) {
                let this->_version = call_user_func(this->_version, this);
            }
        }
     ...
     */
    public function beforeAction( action) -> boolean
    {
        var event;
