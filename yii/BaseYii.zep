...
class BaseYii
{
    ...
    public static function getLogger()
    {
        if $static::$_logger !== null {
            ...
            let $static::$_logger = $static::createObject("yii\\log\\Logger");
            return $static::$_logger;
        }
    }
    ...
    public static function t(string category, string message, var params = [], language = null)
    {
        if $static::$app !== null {
            ...
            var emptyArr;
            let emptyArr = [];
            return (p === emptyArr) ? message : strtr(message, p);
        }
    }
