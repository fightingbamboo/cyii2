...
class Instance
{
     ...
     *
     * If you do not specify a container, the method will first try `BaseYii::$app` followed by `BaseYii::$container`.
     *
     * For example,
     *
     * ```php
     ...
     */
    public static function ensure(var reference, var type = null,var container = null)
    {
        var $class, component, valueType;

        if is_array(reference) {
            let $class =  isset reference["class"] ? reference["class"]  : type;
            if( typeof container != "object" || !(container instanceof Container) ) {
                let container =  BaseYii::container;
            }
        ...
        if is_object(reference) && reference instanceof Container {
     ...
     * If null, the method will first try `BaseYii::$app` then `BaseYii::$container`.
     * @return object the actual object referenced by this Instance object.
     */
    public function get(var container = null)
    {
        var app = BaseYii::app;
        if container {
