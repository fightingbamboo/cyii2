...
abstract class Application extends Module
{
    ...
    public function __construct(config = [])
    {
        ...
        let this->state = self::STATE_BEGIN;
    ...
    protected function bootstrap()
    {
        ...
        if (this->extensions === null) {
            file = BaseYii::getAlias("@vendor/yiisoft/extensions.php");
            let this->extensions = is_file(file) ? include(file) : [];
        }
     ...
     */
     //todo protected function registerErrorHandler(&$config)
...
//            let config["components"] = components;
    ...
    public function setVendorPath(path)
    {
        ...
        BaseYii::setAlias("@bower", this->_vendorPath . DIRECTORY_SEPARATOR . "bower");
        BaseYii::setAlias("@npm", this->_vendorPath . DIRECTORY_SEPARATOR . "npm");
    }
    ...
    public function coreComponents()
    {
        ...
        let elements["log"]          = ["class" : "yii\\log\\Dispatcher"],
            ...
            elements["security"]     = ["class" : "yii\\base\\Security"];
        return elements;
    }
