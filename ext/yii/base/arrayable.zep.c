...
ZEPHIR_INIT_CLASS(yii_base_Arrayable) {
	...
	ZEPHIR_REGISTER_INTERFACE(yii\\base, Arrayable, yii, base_arrayable, yii_base_arrayable_method_entry);
 ...
 * @see toArray()
 */
ZEPHIR_DOC_METHOD(yii_base_Arrayable, fields);
 ...
 * @see fields()
 */
ZEPHIR_DOC_METHOD(yii_base_Arrayable, extraFields);
 ...
 */
ZEPHIR_DOC_METHOD(yii_base_Arrayable, toArray);
